...
const faqs = [
  ...
  { q: "Funciona para lojas de material de construção e de móveis?", a: "Sim! Nosso trabalho é 100% focado nesses dois segmentos. Conhecemos o comportamento do consumidor que busca materiais de obra, acabamentos, móveis e decoração — e sabemos como atraí-los via Google, Instagram e WhatsApp." },
