...
const faqs = [
  ...
  { q: "Vocês atendem lojas de qualquer cidade?", a: "Sim, atendemos lojas de material de construção, móveis e eletro em todo o Brasil. Nossa estratégia digital é adaptada para cada região, focando no público local da sua cidade." },
];
