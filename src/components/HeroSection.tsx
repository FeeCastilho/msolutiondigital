          ...
          <div className="space-y-8">
            ...
            >
              ...
              <span className="text-sm text-muted-foreground tracking-wider uppercase">
                Especialistas em Lojas de Construção , Lojas de Móveis e Eletro
              </span>
            </div>
            ...
            >
              Estratégia e posicionamento orgânico para {""}
              <span className="text-foreground font-medium">empresas</span> que querem gerar clientes
              todos os dias.
            </p>
