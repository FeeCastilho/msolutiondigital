...
import { NAV_ITEMS, SECTION_IDS, WHATSAPP_LINK } from "@/lib/constants";
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-border/50">
            ...
            <button
              ...
              className="w-10 h-10 flex items-center justify-center rounded-xl border border-border text-foreground hover:text-primary transition-all duration-300 hover:scale-95"
              aria-label="Fechar"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            {NAV_ITEMS.map((item, i) => {
              ...
              return (
                <a
                  ...
                  href={item.href}
                  onClick={() => setMobileOpen(false)}
                  className={`group flex items-center gap-4 px-6 py-5 rounded-2xl text-lg font-display font-semibold transition-all duration-300 ${
                    isActive
                      ? "text-primary bg-primary/10"
                      : "text-muted-foreground hover:text-foreground hover:bg-brand-navy/10"
                  }`}
          ...
          <div className="px-8 pb-10">
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setMobileOpen(false)}
              className="flex items-center justify-center gap-3 w-full px-6 py-4 rounded-2xl bg-primary text-primary-foreground font-display font-bold text-base transition-all duration-300 active:scale-[0.97] shadow-[0_4px_30px_hsl(45_95%_52%/0.35)] hover:shadow-[0_6px_40px_hsl(45_95%_52%/0.5)]"
            >
